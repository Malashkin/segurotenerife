...
// «Липкая» тема: общий 'med' не затирает уже известный конкретный вид.
const GENERIC = new Set(['med']);
const stick = (prev, next) => (!next ? prev : (!GENERIC.has(next) || !prev ? next : prev));

...
Человеческий вход. Операционная версия (команды, конвенции, готчи) для людей и
AI-агентов — в [`AGENTS.md`](AGENTS.md).

## По ролям
- **AI / backend:** [ai/rag-agent.md](ai/rag-agent.md) — RAG-агент чата.
- **Frontend:** [architecture/astro-web.md](architecture/astro-web.md) — веб на Astro.

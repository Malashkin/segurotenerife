...
- **Карточки** секции «Статьи» кликабельны там, где статья для локали есть;
  иначе «Скоро».
- Опубликовано: **17 тем × 4 языка (ru/uk/en/es) = 68 статей**. Последними
  добавлены: нелюкративная виза (NLV), частная vs государственная медицина,
  студенческая виза, как выбрать/сменить страховку (перед этим: стоматология,
  питомцы, пенсионеры, беременность и роды).

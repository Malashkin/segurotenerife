...
- **Карточки** секции «Статьи» кликабельны там, где статья для локали есть;
  иначе «Скоро».
- Опубликовано: **19 тем × 4 языка (ru/uk/en/es) = 76 статей**. Последними
  добавлены: воссоединение семьи (reagrupación familiar), первые шаги после
  переезда (чек-лист новосёла); перед этим — нелюкративная виза (NLV), частная vs
  государственная медицина, студенческая виза, как выбрать/сменить страховку,
  стоматология, питомцы, пенсионеры, беременность и роды.
